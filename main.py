...
description = """
TA-Lib Pattern Recognition API helps you do awesome stuff. 🚀
...
# create app
app = FastAPI(
    title="TA-Lib Pattern Recognition API",
    description=description,
    version="0.0.1",
    license_info={
        "name": "Github",
        "url": "https://github.com/hasindusithmin/TA-Lib-Pattern-Recognition",
    },
)
